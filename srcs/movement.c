...
{
	if (!(vars->game->board[(int)(vars->player.pos_x + vars->player.dir_x * speed * 2)][(int)vars->player.pos_y] == '1'))
	{
		vars->player.pos_x = vars->player.pos_x + vars->player.dir_x * speed;
	}
	if (!(vars->game->board[(int)vars->player.pos_x][(int)(vars->player.pos_y + vars->player.dir_y * speed * 2)] == '1'))
	{
...
void	right(t_vars *vars)
{
	...
	if (!(vars->game->board[(int)(vars->player.pos_x - turnx * speed * 2)][(int)vars->player.pos_y] == '1'))
	{
		vars->player.pos_x = vars->player.pos_x - turnx * speed;
	}
	if (!(vars->game->board[(int)vars->player.pos_x][(int)(vars->player.pos_y - turny * speed * 2)] == '1'))
	{
